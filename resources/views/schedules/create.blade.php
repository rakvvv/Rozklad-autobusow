<!DOCTYPE html>
<html lang="en">
@include('shared.head', ['pageTitle' => 'Dodaj Przejazd'])
...
@include('shared.session-error')
    <h1>Dodaj Przejazd</h1>
    <form method="POST" action="{{ route('schedules.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
        <div class="form-group mb-2">
            <label for="bus_number" class="form-label">Numer Autobusu</label>
            <input type="text" name="bus_number" id="bus_number" class="form-control @if ($errors->first('bus_number')) is-invalid @endif" required maxlength="255">
        ...
        <div class="form-group mb-2">
            ...
            <input type="number" step="0.01" name="distance" id="distance" class="form-control @if ($errors->first('distance')) is-invalid @endif" required min="0">
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" name="departure_city" id="departure_city" class="form-control @if ($errors->first('departure_city')) is-invalid @endif" required maxlength="255">
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" name="arrival_city" id="arrival_city" class="form-control @if ($errors->first('arrival_city')) is-invalid @endif" required maxlength="255">
        ...
        <div class="form-group mb-2">
            ...
            <input type="datetime-local" name="departure_time" id="departure_time" class="form-control @if ($errors->first('departure_time')) is-invalid @endif" required>
        ...
        <div class="form-group mb-2">
            ...
            <input type="datetime-local" name="arrival_time" id="arrival_time" class="form-control @if ($errors->first('arrival_time')) is-invalid @endif" required>
        ...
        <div class="form-group mb-2">
            ...
            <input type="number" step="0.01" name="ticket_price" id="ticket_price" class="form-control @if ($errors->first('ticket_price')) is-invalid @endif" required min="0">
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" name="stops[]" id="stops" class="form-control @if ($errors->first('stops')) is-invalid @endif" required>
            <div class="invalid-feedback">Przystanki są wymagane.</div>
        </div>
        <button type="submit" class="btn btn-primary">Dodaj Przejazd</button>
    </form>
</div>
